...
setup( name = "buoyantBoussinesqPisoFlux",
       description = 'Python front-end of the buoyantBoussinesqPisoFoam',
       author = 'Alexey Petrov',
       ...
       entry_points = { 'console_scripts': [
           'buoyantBoussinesqPisoFlux = buoyantBoussinesqPisoFlux:entry_point'] },
       zip_safe = True )
